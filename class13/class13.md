...
Setup the object that DESeq needs for analysis with the lovely
...
by running the `resultsNames(dds)` command).
...
> many genes are up- or down-regulated at the default 0.1 p-value
> cutoff.
...
Our pathway analysis downstream will use KEGG pathways, and genes in
...
IDs and we have the fold change results from DESeq2 analysis.
...
To begin with, let’s manually supply a pathway.id (namely the first part
...
```
    ...
    Info: Working in directory C:/Users/Olivia Chu/Documents/UCSD/Senior (2022-23)/Winter 2023/BIMM 143 (Grant)/bimm143_github/class13
...
Finally, let’s pass these IDs in keggresids to the `pathview()` function
...
The pathway with the most significant “Entities p-value” is
Endosomal/Vacuolar pathway. No, not many most significant pathways
listed match my previous KEGG results.
